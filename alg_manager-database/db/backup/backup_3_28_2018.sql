...
INSERT INTO `algorithm` VALUES (1,'Kruskal\'s algorithm','O(E*α(V))',12,3),(2,'Prim\'s algorithm','O(E*lg(V))',12,3),(5,'Dijkstra\'s algorithm','O(E*lg(V))',1,3),(6,'Bellman-Ford algorithm','O(V*E)',1,2),(7,'Floyd-Warshall algorithm','O(V^3)',1,2),(14,'Topological sorting','O(V + E)',1,4),(15,'Ford-Fulkerson algorithm','O(E*|f|)',17,4),(17,'Dinic\'s algorithm','O(V^2*E)',17,4),(18,'Push-relabel','O(V^2*E)',17,4),(20,'Relabel-to-front','O(V^3)',17,4),(21,'Quicksort','O(lg(n)) average, O(n^2) worst',3,1),(22,'Merge sort','O(lg(n))',3,1),(23,'0-1 knapsack','O(n*W)',14,2),(24,'Edmonds-Karp algorithm','O(V*E^2)',17,4),(25,'Simplex','exponential',5,4),(27,'A*','exponential worst case',1,3),(28,'Improved push-relabel','O(V^3)',1,4),(29,'Приготовить обед','просто',18,20),(30,'Blossom V','O(VE^2)',12,4),(31,'Aaaa','bbbb',13,18),(32,'abhbb','g',20,19),(33,'THE algorithm','O(x^(-1))',21,23);
...
CREATE TABLE `algorithm_application` (
  ...
  KEY `fk_algorithm_application` (`app_algorithm_id`),
...
INSERT INTO `algorithm_application` VALUES (1,5,2),(2,30,6),(3,14,4),(4,31,6),(6,6,3),(7,23,4),(8,23,8);
...
CREATE TABLE `algorithm_reference` (
  ...
  KEY `fk_algorithm_reference` (`ref_algorithm_id`),
...
INSERT INTO `algorithm_reference` VALUES (1,15,1),(2,6,1),(3,33,7);
...
INSERT INTO `area_of_use` VALUES (1,'Electrical circuit design','Optiman interconnection of electrical pins with minimum amount of wire'),(2,'Shortest path problem','In graph theory, the shortest path problem is the problem of finding a path between two vertices (or nodes) in a graph such that the sum of the weights of its constituent edges is minimized.'),(3,'Negative weight cycle search problem','Given a graph G = (V, E), find all its negative weight cycles'),(4,'Array sorting problem','Given an array of comparable objects, output them in sorted order'),(5,'Накормить людей',NULL),(6,'Minimum weight perfect matching',NULL),(8,'solve problem','dhbjhfdjfjhdfjdfjhfd');
...
INSERT INTO `author` VALUES (1,'Donald','Knuth'),(2,'Thomas','Cormen'),(3,'Charles','Leiserson'),(4,'Ronald','Rivest'),(5,'Clifford','Stein'),(16,'Donald','Knuthjjj'),(17,'Donald','Knuthhhhh'),(18,'Donald','Knuthhhh'),(19,'Donald','Knut'),(20,'Donald','Knu'),(21,'Thomas','Corm'),(22,'God','himself');
...
INSERT INTO `book` VALUES (1,'Introduction to algorithms',NULL,3),(2,'The art of computer programming',1,3),(3,'The art of computer programming',2,3),(6,'The art of computer programming',3,2),(7,'THE Book',1,43);
...
INSERT INTO `textbook` VALUES (2,1),(3,1),(6,1),(1,2),(1,3),(1,4),(1,5),(7,22);
...
-- Dump completed on 2018-03-28  9:54:00
