...
INSERT INTO `algorithm` VALUES (1,'O(E*α(V)','O(E*α(V))',12,3),(2,'Prim\'s algorithm','O(E*lg(V))',12,3),(5,'Dijkstra\'s algorithm','O(E*lg(V))',1,3),(6,'Bellman-Ford algorithm','O(V*E)',1,2),(7,'Floyd-Warshall algorithm','O(V^3)',1,2),(8,'Binary search','O(lg(n))',2,1),(14,'Topological sorting','O(V + E)',1,4),(15,'Ford-Fulkerson algorithm','O(E*|f|)',17,4),(17,'Dinic\'s algorithm','O(V^2*E)',17,4),(18,'Push-relabel','O(V^2*E)',17,4),(19,'Improved push-relabel','O(V^3)',17,4),(20,'Relabel-to-front','O(V^3)',17,4),(21,'Quicksort','O(lg(n)) average, O(n^2) worst',3,1),(22,'Merge sort','O(lg(n))',3,1),(23,'0-1 knapsack','O(n*W)',14,2),(24,'Edmonds-Karp algorithm','O(V*E^2)',17,4);
...
INSERT INTO `area_of_use` VALUES (1,'Electrical circuit design','Optiman interconnection of electrical pins with minimum amount of wire');
...
INSERT INTO `book` VALUES (1,'Introduction to algorithms',NULL,3),(2,'The art of computer programming',1,3),(3,'The art of computer programming',2,3),(4,'The art of computer programming',3,2),(5,'The algorithms',1,1);
...
INSERT INTO `textbook` VALUES (2,1),(3,1),(4,1),(1,2),(1,3),(1,4),(1,5),(5,6),(5,7);
